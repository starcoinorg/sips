...
5. If you want to move S from Layer2 back to Layer1, do the same thing, but in reverse order. The movement from Layer2 to Layer1 has different challenge periods for different scenarios, and the intermediate state is locked in the SpacetimeBox during the challenge period.
